...
function dibujar(){    
    if(Mapa.fondo.cargaOk&&Animales.vaca.cargaOk&&Animales.cerdo.cargaOk&&Animales.pollo.cargaOk){
        ...
        for(var i=0; i<numeroVacas; i++){
            paper.drawImage(Animales.vaca.imagen,randomNumber(min,max),randomNumber(min,max));
        }
        for(var i=0; i<numeroCerdos; i++){
            paper.drawImage(Animales.cerdo.imagen,randomNumber(min,max),randomNumber(min,max));
        }
